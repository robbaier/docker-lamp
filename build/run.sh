...
function replace_apache_php_ini_values () {
    ...
    sed -i "s/;date.timezone =/date.timezone = America\/Chicago/g" /etc/php/$1/apache2/php.ini
...
function replace_cli_php_ini_values () {
    ...
    sed -i  "s/;date.timezone =/date.timezone = America\/Chicago/g" /etc/php/$1/cli/php.ini
}
